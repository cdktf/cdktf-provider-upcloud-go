...
func (m *jsiiProxy_ManagedDatabaseOpensearchPropertiesDiskWatermarksOutputReference) InterpolationForAttribute(property *string) cdktf.IResolvable {
...
func (m *jsiiProxy_ManagedDatabaseOpensearchPropertiesDiskWatermarksOutputReference) Resolve(_context cdktf.IResolveContext) interface{} {
