...
// Create a new {@link https://registry.terraform.io/providers/upcloudltd/upcloud/3.0.3/docs/resources/managed_database_opensearch upcloud_managed_database_opensearch} Resource.
...
func (m *jsiiProxy_ManagedDatabaseOpensearch) ResetTitle() {
	_jsii_.InvokeVoid(
		m,
		"resetTitle",
		nil, // no parameters
