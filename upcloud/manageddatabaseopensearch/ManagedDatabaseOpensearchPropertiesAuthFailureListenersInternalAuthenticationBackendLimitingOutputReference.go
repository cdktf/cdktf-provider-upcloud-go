...
func (m *jsiiProxy_ManagedDatabaseOpensearchPropertiesAuthFailureListenersInternalAuthenticationBackendLimitingOutputReference) InterpolationForAttribute(property *string) cdktf.IResolvable {
...
func (m *jsiiProxy_ManagedDatabaseOpensearchPropertiesAuthFailureListenersInternalAuthenticationBackendLimitingOutputReference) Resolve(_context cdktf.IResolveContext) interface{} {
