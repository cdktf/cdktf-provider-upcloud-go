...
func (m *jsiiProxy_ManagedDatabaseOpensearchPropertiesIndexRollupOutputReference) InterpolationForAttribute(terraformAttribute *string) cdktf.IResolvable {
...
func (m *jsiiProxy_ManagedDatabaseOpensearchPropertiesIndexRollupOutputReference) Resolve(context cdktf.IResolveContext) interface{} {
