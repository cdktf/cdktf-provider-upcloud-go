...
func (m *jsiiProxy_ManagedDatabaseOpensearchPropertiesSamlOutputReference) InterpolationForAttribute(terraformAttribute *string) cdktf.IResolvable {
...
func (m *jsiiProxy_ManagedDatabaseOpensearchPropertiesSamlOutputReference) Resolve(context cdktf.IResolveContext) interface{} {
