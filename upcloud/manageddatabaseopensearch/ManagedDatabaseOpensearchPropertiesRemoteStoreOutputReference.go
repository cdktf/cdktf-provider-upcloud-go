...
func (m *jsiiProxy_ManagedDatabaseOpensearchPropertiesRemoteStoreOutputReference) InterpolationForAttribute(property *string) cdktf.IResolvable {
...
func (m *jsiiProxy_ManagedDatabaseOpensearchPropertiesRemoteStoreOutputReference) Resolve(_context cdktf.IResolveContext) interface{} {
