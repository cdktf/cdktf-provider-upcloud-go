...
func (m *jsiiProxy_ManagedDatabaseOpensearchPropertiesIndexTemplateOutputReference) InterpolationForAttribute(terraformAttribute *string) cdktf.IResolvable {
...
func (m *jsiiProxy_ManagedDatabaseOpensearchPropertiesIndexTemplateOutputReference) Resolve(context cdktf.IResolveContext) interface{} {
