...
type NetworkPeering interface {
	...
	PeerNetwork() NetworkPeeringPeerNetworkList
	PeerNetworkInput() interface{}
	// Experimental.
	...
	PutPeerNetwork(value interface{})
...
func (j *jsiiProxy_NetworkPeering) ConfiguredStatus() *string {
	var returns *string
	_jsii_.Get(
		j,
		"configuredStatus",
...
func (j *jsiiProxy_NetworkPeering) ConfiguredStatusInput() *string {
	var returns *string
	_jsii_.Get(
		j,
...
func (j *jsiiProxy_NetworkPeering) Labels() *map[string]*string {
...
func (j *jsiiProxy_NetworkPeering) LabelsInput() *map[string]*string {
	var returns *map[string]*string
	_jsii_.Get(
		j,
		"labelsInput",
...
func (j *jsiiProxy_NetworkPeering) Name() *string {
	var returns *string
	_jsii_.Get(
		j,
		"name",
...
func (j *jsiiProxy_NetworkPeering) NameInput() *string {
	var returns *string
	_jsii_.Get(
		j,
		"nameInput",
...
func (j *jsiiProxy_NetworkPeering) Network() NetworkPeeringNetworkList {
	var returns NetworkPeeringNetworkList
	_jsii_.Get(
		j,
		"network",
		&returns,
...
func (j *jsiiProxy_NetworkPeering) NetworkInput() interface{} {
	var returns interface{}
	_jsii_.Get(
		j,
		"networkInput",
...
func (j *jsiiProxy_NetworkPeering) PeerNetwork() NetworkPeeringPeerNetworkList {
	var returns NetworkPeeringPeerNetworkList
	_jsii_.Get(
		j,
		"peerNetwork",
		&returns,
...
func (j *jsiiProxy_NetworkPeering) PeerNetworkInput() interface{} {
	var returns interface{}
	_jsii_.Get(
		j,
		"peerNetworkInput",
...
// Create a new {@link https://registry.terraform.io/providers/upcloudltd/upcloud/5.20.1/docs/resources/network_peering upcloud_network_peering} Resource.
...
func (j *jsiiProxy_NetworkPeering)SetConfiguredStatus(val *string) {
...
func (j *jsiiProxy_NetworkPeering)SetLabels(val *map[string]*string) {
...
func (j *jsiiProxy_NetworkPeering)SetName(val *string) {
...
func (n *jsiiProxy_NetworkPeering) PutNetwork(value interface{}) {
	if err := n.validatePutNetworkParameters(value); err != nil {
		panic(err)
	}
	_jsii_.InvokeVoid(
		n,
...
func (n *jsiiProxy_NetworkPeering) PutPeerNetwork(value interface{}) {
	if err := n.validatePutPeerNetworkParameters(value); err != nil {
		panic(err)
	}
	_jsii_.InvokeVoid(
		n,
...
func (n *jsiiProxy_NetworkPeering) ResetConfiguredStatus() {
	_jsii_.InvokeVoid(
		n,
		"resetConfiguredStatus",
		nil, // no parameters
...
func (n *jsiiProxy_NetworkPeering) ResetLabels() {
	_jsii_.InvokeVoid(
		n,
		"resetLabels",
		nil, // no parameters
...
func (n *jsiiProxy_NetworkPeering) ResetNetwork() {
	_jsii_.InvokeVoid(
		n,
		"resetNetwork",
		nil, // no parameters
...
func (n *jsiiProxy_NetworkPeering) ResetPeerNetwork() {
	_jsii_.InvokeVoid(
		n,
		"resetPeerNetwork",
		nil, // no parameters
