...
import (
	...
	"github.com/cdktf/cdktf-provider-upcloud-go/upcloud/v14/kubernetescluster/internal"
...
func (j *jsiiProxy_KubernetesCluster) Plan() *string {
	var returns *string
	_jsii_.Get(
		j,
		"plan",
...
func (j *jsiiProxy_KubernetesCluster) PlanInput() *string {
	var returns *string
	_jsii_.Get(
		j,
		"planInput",
...
// Create a new {@link https://registry.terraform.io/providers/upcloudltd/upcloud/5.13.2/docs/resources/kubernetes_cluster upcloud_kubernetes_cluster} Resource.
...
func (j *jsiiProxy_KubernetesCluster)SetPlan(val *string) {
...
func (k *jsiiProxy_KubernetesCluster) ResetPlan() {
	_jsii_.InvokeVoid(
		k,
		"resetPlan",
		nil, // no parameters
...
func (k *jsiiProxy_KubernetesCluster) ResetVersion() {
	_jsii_.InvokeVoid(
		k,
		"resetVersion",
		nil, // no parameters
