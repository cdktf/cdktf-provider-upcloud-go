...
type KubernetesCluster interface {
	...
	NodeGroup() KubernetesClusterNodeGroupList
...
func (j *jsiiProxy_KubernetesCluster) NodeGroup() KubernetesClusterNodeGroupList {
	var returns KubernetesClusterNodeGroupList
	_jsii_.Get(
		j,
		"nodeGroup",
		&returns,
...
func (j *jsiiProxy_KubernetesCluster) NodeGroupInput() interface{} {
	var returns interface{}
	_jsii_.Get(
		j,
		"nodeGroupInput",
...
func (k *jsiiProxy_KubernetesCluster) PutNodeGroup(value interface{}) {
	if err := k.validatePutNodeGroupParameters(value); err != nil {
		panic(err)
	}
	_jsii_.InvokeVoid(
		k,
