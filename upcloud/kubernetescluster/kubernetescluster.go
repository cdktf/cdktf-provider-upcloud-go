...
func init() {
	...
	_jsii_.RegisterStruct(
		"@cdktf/provider-upcloud.kubernetesCluster.KubernetesClusterNodeGroup",
		reflect.TypeOf((*KubernetesClusterNodeGroup)(nil)).Elem(),
	)
	_jsii_.RegisterClass(
		"@cdktf/provider-upcloud.kubernetesCluster.KubernetesClusterNodeGroupList",
		reflect.TypeOf((*KubernetesClusterNodeGroupList)(nil)).Elem(),
		[]_jsii_.Member{
	...
	_jsii_.RegisterClass(
		...
		reflect.TypeOf((*KubernetesClusterNodeGroupOutputReference)(nil)).Elem(),
		[]_jsii_.Member{
	...
	_jsii_.RegisterStruct(
		"@cdktf/provider-upcloud.kubernetesCluster.KubernetesClusterNodeGroupTaint",
		reflect.TypeOf((*KubernetesClusterNodeGroupTaint)(nil)).Elem(),
	)
	_jsii_.RegisterClass(
		"@cdktf/provider-upcloud.kubernetesCluster.KubernetesClusterNodeGroupTaintList",
		reflect.TypeOf((*KubernetesClusterNodeGroupTaintList)(nil)).Elem(),
		[]_jsii_.Member{
			_jsii_.MemberMethod{JsiiMethod: "computeFqn", GoMethod: "ComputeFqn"},
			_jsii_.MemberProperty{JsiiProperty: "creationStack", GoGetter: "CreationStack"},
			_jsii_.MemberProperty{JsiiProperty: "fqn", GoGetter: "Fqn"},
	...
	_jsii_.RegisterClass(
		...
		reflect.TypeOf((*KubernetesClusterNodeGroupTaintOutputReference)(nil)).Elem(),
		[]_jsii_.Member{
			_jsii_.MemberProperty{JsiiProperty: "complexObjectIndex", GoGetter: "ComplexObjectIndex"},
			_jsii_.MemberProperty{JsiiProperty: "complexObjectIsFromSet", GoGetter: "ComplexObjectIsFromSet"},
			_jsii_.MemberMethod{JsiiMethod: "computeFqn", GoMethod: "ComputeFqn"},
