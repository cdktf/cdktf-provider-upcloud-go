...
func init() {
	_jsii_.RegisterClass(
		...
		reflect.TypeOf((*DataUpcloudManagedDatabaseOpensearchIndices)(nil)).Elem(),
		[]_jsii_.Member{
			...
			_jsii_.MemberMethod{JsiiMethod: "putIndices", GoMethod: "PutIndices"},
			_jsii_.MemberProperty{JsiiProperty: "rawOverrides", GoGetter: "RawOverrides"},
			_jsii_.MemberMethod{JsiiMethod: "resetId", GoMethod: "ResetId"},
			_jsii_.MemberMethod{JsiiMethod: "resetIndices", GoMethod: "ResetIndices"},
	...
	_jsii_.RegisterStruct(
		...
		reflect.TypeOf((*DataUpcloudManagedDatabaseOpensearchIndicesConfig)(nil)).Elem(),
	)
	_jsii_.RegisterStruct(
		"@cdktf/provider-upcloud.dataUpcloudManagedDatabaseOpensearchIndices.DataUpcloudManagedDatabaseOpensearchIndicesIndices",
		reflect.TypeOf((*DataUpcloudManagedDatabaseOpensearchIndicesIndices)(nil)).Elem(),
	)
	_jsii_.RegisterClass(
		...
		reflect.TypeOf((*DataUpcloudManagedDatabaseOpensearchIndicesIndicesList)(nil)).Elem(),
		[]_jsii_.Member{
	...
	_jsii_.RegisterClass(
		...
		reflect.TypeOf((*DataUpcloudManagedDatabaseOpensearchIndicesIndicesOutputReference)(nil)).Elem(),
		[]_jsii_.Member{
			...
			_jsii_.MemberProperty{JsiiProperty: "readOnlyAllowDelete", GoGetter: "ReadOnlyAllowDelete"},
			_jsii_.MemberMethod{JsiiMethod: "resolve", GoMethod: "Resolve"},
