...
func (m *jsiiProxy_ManagedObjectStorage) validateMoveFromIdParameters(id *string) error {
	if id == nil {
		return fmt.Errorf("parameter id is required, but nil was provided")
	}
...
func (m *jsiiProxy_ManagedObjectStorage) validateMoveToIdParameters(id *string) error {
	if id == nil {
		return fmt.Errorf("parameter id is required, but nil was provided")
	}
...
func (m *jsiiProxy_ManagedObjectStorage) validatePutNetworkParameters(value interface{}) error {
	...
	case *[]*ManagedObjectStorageNetwork:
		value := value.(*[]*ManagedObjectStorageNetwork)
	...
	case []*ManagedObjectStorageNetwork:
		value_ := value.([]*ManagedObjectStorageNetwork)
		value := &value_
		for idx_cd4240, v := range *value {
			if err := _jsii_.ValidateStruct(v, func() string { return fmt.Sprintf("parameter value[%#v]", idx_cd4240) }); err != nil {
				return err
	...
	default:
		if !_jsii_.IsAnonymousProxy(value) {
			return fmt.Errorf("parameter value must be one of the allowed types: cdktf.IResolvable, *[]*ManagedObjectStorageNetwork; received %#v (a %T)", value, value)
		}
	}
...
func (j *jsiiProxy_ManagedObjectStorage) validateSetNameParameters(val *string) error {
	if val == nil {
		return fmt.Errorf("parameter val is required, but nil was provided")
	}
