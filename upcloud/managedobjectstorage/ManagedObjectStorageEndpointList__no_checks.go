...
func (m *jsiiProxy_ManagedObjectStorageEndpointList) validateAllWithMapKeyParameters(mapKeyAttributeName *string) error {
	return nil
}
...
func (m *jsiiProxy_ManagedObjectStorageEndpointList) validateResolveParameters(context cdktf.IResolveContext) error {
	return nil
}
