...
func (s *jsiiProxy_ServerLoginOutputReference) InterpolationForAttribute(terraformAttribute *string) cdktf.IResolvable {
...
func (s *jsiiProxy_ServerLoginOutputReference) Resolve(context cdktf.IResolveContext) interface{} {
