...
func (s *jsiiProxy_Server) validatePutNetworkInterfaceParameters(value interface{}) error {
	...
	case *[]*ServerNetworkInterface:
		value := value.(*[]*ServerNetworkInterface)
		for idx_cd4240, v := range *value {
			if err := _jsii_.ValidateStruct(v, func() string { return fmt.Sprintf("parameter value[%#v]", idx_cd4240) }); err != nil {
				return err
			}
	...
	case []*ServerNetworkInterface:
		value_ := value.([]*ServerNetworkInterface)
		value := &value_
		for idx_cd4240, v := range *value {
			if err := _jsii_.ValidateStruct(v, func() string { return fmt.Sprintf("parameter value[%#v]", idx_cd4240) }); err != nil {
				return err
	...
	default:
		if !_jsii_.IsAnonymousProxy(value) {
			return fmt.Errorf("parameter value must be one of the allowed types: cdktf.IResolvable, *[]*ServerNetworkInterface; received %#v (a %T)", value, value)
		}
	}
...
func (s *jsiiProxy_Server) validatePutStorageDevicesParameters(value interface{}) error {
	...
	case *[]*ServerStorageDevices:
		value := value.(*[]*ServerStorageDevices)
		for idx_cd4240, v := range *value {
			if err := _jsii_.ValidateStruct(v, func() string { return fmt.Sprintf("parameter value[%#v]", idx_cd4240) }); err != nil {
				return err
			}
	...
	case []*ServerStorageDevices:
		value_ := value.([]*ServerStorageDevices)
		value := &value_
		for idx_cd4240, v := range *value {
			if err := _jsii_.ValidateStruct(v, func() string { return fmt.Sprintf("parameter value[%#v]", idx_cd4240) }); err != nil {
				return err
	...
	default:
		if !_jsii_.IsAnonymousProxy(value) {
			return fmt.Errorf("parameter value must be one of the allowed types: cdktf.IResolvable, *[]*ServerStorageDevices; received %#v (a %T)", value, value)
		}
	}
...
func (j *jsiiProxy_Server) validateSetHotResizeParameters(val interface{}) error {
	if val == nil {
		return fmt.Errorf("parameter val is required, but nil was provided")
	}
	switch val.(type) {
