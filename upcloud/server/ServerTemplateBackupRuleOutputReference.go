...
func (s *jsiiProxy_ServerTemplateBackupRuleOutputReference) InterpolationForAttribute(terraformAttribute *string) cdktf.IResolvable {
...
func (s *jsiiProxy_ServerTemplateBackupRuleOutputReference) Resolve(context cdktf.IResolveContext) interface{} {
