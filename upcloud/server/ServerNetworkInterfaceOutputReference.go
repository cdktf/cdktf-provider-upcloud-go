...
func (s *jsiiProxy_ServerNetworkInterfaceOutputReference) InterpolationForAttribute(terraformAttribute *string) cdktf.IResolvable {
...
func (s *jsiiProxy_ServerNetworkInterfaceOutputReference) Resolve(context cdktf.IResolveContext) interface{} {
