...
type ManagedDatabaseMysqlComponentsList interface {
	cdktf.ComplexList
	...
	// Experimental.
	ComputeFqn() *string
	Get(index *float64) ManagedDatabaseMysqlComponentsOutputReference
...
// The jsii proxy struct for ManagedDatabaseMysqlComponentsList
type jsiiProxy_ManagedDatabaseMysqlComponentsList struct {
	internal.Type__cdktfComplexList
}

func (j *jsiiProxy_ManagedDatabaseMysqlComponentsList) CreationStack() *[]*string {
	var returns *[]*string
	_jsii_.Get(
		j,
		"creationStack",
...
func (j *jsiiProxy_ManagedDatabaseMysqlComponentsList) Fqn() *string {
	var returns *string
	_jsii_.Get(
		j,
		"fqn",
...
func (j *jsiiProxy_ManagedDatabaseMysqlComponentsList) TerraformAttribute() *string {
	var returns *string
	_jsii_.Get(
		j,
		"terraformAttribute",
...
func (j *jsiiProxy_ManagedDatabaseMysqlComponentsList) TerraformResource() cdktf.IInterpolatingParent {
...
func (j *jsiiProxy_ManagedDatabaseMysqlComponentsList) WrapsSet() *bool {
	var returns *bool
	_jsii_.Get(
		j,
		"wrapsSet",
...
func (m *jsiiProxy_ManagedDatabaseMysqlComponentsList) AllWithMapKey(mapKeyAttributeName *string) cdktf.DynamicListTerraformIterator {
...
func (m *jsiiProxy_ManagedDatabaseMysqlComponentsList) ComputeFqn() *string {
	var returns *string
...
func (m *jsiiProxy_ManagedDatabaseMysqlComponentsList) Resolve(context cdktf.IResolveContext) interface{} {
...
func (m *jsiiProxy_ManagedDatabaseMysqlComponentsList) ToString() *string {
	var returns *string
