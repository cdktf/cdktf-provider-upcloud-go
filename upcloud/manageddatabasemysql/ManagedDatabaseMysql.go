...
func (j *jsiiProxy_ManagedDatabaseMysql) Count() interface{} {
	var returns interface{}
	_jsii_.Get(
		j,
		"count",
...
func (j *jsiiProxy_ManagedDatabaseMysql) Labels() *map[string]*string {
...
func (j *jsiiProxy_ManagedDatabaseMysql) LabelsInput() *map[string]*string {
	var returns *map[string]*string
	_jsii_.Get(
		j,
		"labelsInput",
...
func (j *jsiiProxy_ManagedDatabaseMysql)SetCount(val interface{}) {
...
func (j *jsiiProxy_ManagedDatabaseMysql)SetLabels(val *map[string]*string) {
...
func ManagedDatabaseMysql_GenerateConfigForImport(scope constructs.Construct, importToId *string, importFromId *string, provider cdktf.TerraformProvider) cdktf.ImportableResource {
	...
	if err := validateManagedDatabaseMysql_GenerateConfigForImportParameters(scope, importToId, importFromId); err != nil {
		panic(err)
	}
...
func ManagedDatabaseMysql_IsTerraformElement(x interface{}) *bool {
	...
	if err := validateManagedDatabaseMysql_IsTerraformElementParameters(x); err != nil {
		panic(err)
	}
	var returns *bool
...
func ManagedDatabaseMysql_IsTerraformResource(x interface{}) *bool {
	...
	if err := validateManagedDatabaseMysql_IsTerraformResourceParameters(x); err != nil {
		panic(err)
	}
	var returns *bool
...
func (m *jsiiProxy_ManagedDatabaseMysql) AddMoveTarget(moveTarget *string) {
...
func (m *jsiiProxy_ManagedDatabaseMysql) ResetLabels() {
	_jsii_.InvokeVoid(
		m,
		"resetLabels",
		nil, // no parameters
...
func (m *jsiiProxy_ManagedDatabaseMysql) SynthesizeHclAttributes() *map[string]interface{} {
	var returns *map[string]interface{}
...
func (m *jsiiProxy_ManagedDatabaseMysql) ToHclTerraform() interface{} {
	var returns interface{}
