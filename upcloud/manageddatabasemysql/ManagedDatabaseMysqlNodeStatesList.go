...
type ManagedDatabaseMysqlNodeStatesList interface {
	cdktf.ComplexList
	...
	// Experimental.
	ComputeFqn() *string
	Get(index *float64) ManagedDatabaseMysqlNodeStatesOutputReference
...
// The jsii proxy struct for ManagedDatabaseMysqlNodeStatesList
type jsiiProxy_ManagedDatabaseMysqlNodeStatesList struct {
	internal.Type__cdktfComplexList
}

func (j *jsiiProxy_ManagedDatabaseMysqlNodeStatesList) CreationStack() *[]*string {
	var returns *[]*string
	_jsii_.Get(
		j,
		"creationStack",
...
func (j *jsiiProxy_ManagedDatabaseMysqlNodeStatesList) Fqn() *string {
	var returns *string
	_jsii_.Get(
		j,
		"fqn",
...
func (j *jsiiProxy_ManagedDatabaseMysqlNodeStatesList) TerraformAttribute() *string {
	var returns *string
	_jsii_.Get(
		j,
		"terraformAttribute",
...
func (j *jsiiProxy_ManagedDatabaseMysqlNodeStatesList) TerraformResource() cdktf.IInterpolatingParent {
...
func (j *jsiiProxy_ManagedDatabaseMysqlNodeStatesList) WrapsSet() *bool {
	var returns *bool
	_jsii_.Get(
		j,
		"wrapsSet",
...
func (m *jsiiProxy_ManagedDatabaseMysqlNodeStatesList) AllWithMapKey(mapKeyAttributeName *string) cdktf.DynamicListTerraformIterator {
...
func (m *jsiiProxy_ManagedDatabaseMysqlNodeStatesList) ComputeFqn() *string {
	var returns *string
...
func (m *jsiiProxy_ManagedDatabaseMysqlNodeStatesList) Resolve(context cdktf.IResolveContext) interface{} {
...
func (m *jsiiProxy_ManagedDatabaseMysqlNodeStatesList) ToString() *string {
	var returns *string
