...
func (m *jsiiProxy_ManagedDatabaseValkeyPropertiesMigrationOutputReference) InterpolationForAttribute(terraformAttribute *string) cdktf.IResolvable {
...
func (m *jsiiProxy_ManagedDatabaseValkeyPropertiesMigrationOutputReference) Resolve(context cdktf.IResolveContext) interface{} {
