...
func (m *jsiiProxy_ManagedDatabaseUser) validateAddMoveTargetParameters(moveTarget *string) error {
	if moveTarget == nil {
...
func (m *jsiiProxy_ManagedDatabaseUser) validateImportFromParameters(id *string) error {
	if id == nil {
...
func (m *jsiiProxy_ManagedDatabaseUser) validateMoveFromIdParameters(id *string) error {
	if id == nil {
		return fmt.Errorf("parameter id is required, but nil was provided")
	}
...
func (m *jsiiProxy_ManagedDatabaseUser) validateMoveToParameters(moveTarget *string, index interface{}) error {
	if moveTarget == nil {
		return fmt.Errorf("parameter moveTarget is required, but nil was provided")
	}
...
func (m *jsiiProxy_ManagedDatabaseUser) validateMoveToIdParameters(id *string) error {
	if id == nil {
		return fmt.Errorf("parameter id is required, but nil was provided")
	}
...
func (j *jsiiProxy_ManagedDatabaseUser) validateSetCountParameters(val interface{}) error {
	switch val.(type) {
	case *float64:
		// ok
	case float64:
