...
func (m *jsiiProxy_ManagedDatabaseUserValkeyAccessControlOutputReference) InterpolationForAttribute(terraformAttribute *string) cdktf.IResolvable {
...
func (m *jsiiProxy_ManagedDatabaseUserValkeyAccessControlOutputReference) Resolve(context cdktf.IResolveContext) interface{} {
