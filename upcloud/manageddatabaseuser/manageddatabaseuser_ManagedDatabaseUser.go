...
import (
	...
	"github.com/hashicorp/cdktf-provider-upcloud-go/upcloud/v3/manageddatabaseuser/internal"
...
func (j *jsiiProxy_ManagedDatabaseUser) Count() *float64 {
	var returns *float64
	_jsii_.Get(
		j,
		"count",
...
func (j *jsiiProxy_ManagedDatabaseUser)SetCount(val *float64) {
	_jsii_.Set(
		j,
		"count",
		val,
