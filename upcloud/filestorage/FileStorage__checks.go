...
func (f *jsiiProxy_FileStorage) validatePutNetworkParameters(value interface{}) error {
	...
	case *[]*FileStorageNetwork:
		value := value.(*[]*FileStorageNetwork)
	...
	case []*FileStorageNetwork:
		value_ := value.([]*FileStorageNetwork)
		value := &value_
		for idx_cd4240, v := range *value {
			if err := _jsii_.ValidateStruct(v, func() string { return fmt.Sprintf("parameter value[%#v]", idx_cd4240) }); err != nil {
				return err
	...
	default:
		if !_jsii_.IsAnonymousProxy(value) {
			return fmt.Errorf("parameter value must be one of the allowed types: cdktf.IResolvable, *[]*FileStorageNetwork; received %#v (a %T)", value, value)
		}
	}
...
func (f *jsiiProxy_FileStorage) validatePutShareParameters(value interface{}) error {
	...
	default:
		if !_jsii_.IsAnonymousProxy(value) {
			return fmt.Errorf("parameter value must be one of the allowed types: cdktf.IResolvable, *[]*FileStorageShare; received %#v (a %T)", value, value)
		}
	}
