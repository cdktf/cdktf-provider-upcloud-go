...
type FirewallRulesFirewallRuleList interface {
	cdktf.ComplexList
	...
	// Experimental.
	ComputeFqn() *string
	Get(index *float64) FirewallRulesFirewallRuleOutputReference
...
// The jsii proxy struct for FirewallRulesFirewallRuleList
type jsiiProxy_FirewallRulesFirewallRuleList struct {
	internal.Type__cdktfComplexList
}

func (j *jsiiProxy_FirewallRulesFirewallRuleList) CreationStack() *[]*string {
	var returns *[]*string
	_jsii_.Get(
		j,
		"creationStack",
...
func (j *jsiiProxy_FirewallRulesFirewallRuleList) Fqn() *string {
	var returns *string
	_jsii_.Get(
		j,
		"fqn",
...
func (j *jsiiProxy_FirewallRulesFirewallRuleList) InternalValue() interface{} {
...
func (j *jsiiProxy_FirewallRulesFirewallRuleList) TerraformAttribute() *string {
	var returns *string
	_jsii_.Get(
		j,
		"terraformAttribute",
...
func (j *jsiiProxy_FirewallRulesFirewallRuleList) TerraformResource() cdktf.IInterpolatingParent {
...
func (j *jsiiProxy_FirewallRulesFirewallRuleList) WrapsSet() *bool {
	var returns *bool
	_jsii_.Get(
		j,
		"wrapsSet",
...
func (f *jsiiProxy_FirewallRulesFirewallRuleList) AllWithMapKey(mapKeyAttributeName *string) cdktf.DynamicListTerraformIterator {
...
func (f *jsiiProxy_FirewallRulesFirewallRuleList) ComputeFqn() *string {
	var returns *string
...
func (f *jsiiProxy_FirewallRulesFirewallRuleList) Resolve(context cdktf.IResolveContext) interface{} {
...
func (f *jsiiProxy_FirewallRulesFirewallRuleList) ToString() *string {
	var returns *string
