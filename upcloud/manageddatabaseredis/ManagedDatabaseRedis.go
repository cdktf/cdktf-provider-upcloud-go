...
// Create a new {@link https://registry.terraform.io/providers/upcloudltd/upcloud/3.0.3/docs/resources/managed_database_redis upcloud_managed_database_redis} Resource.
...
func (m *jsiiProxy_ManagedDatabaseRedis) ResetTitle() {
	_jsii_.InvokeVoid(
		m,
		"resetTitle",
		nil, // no parameters
