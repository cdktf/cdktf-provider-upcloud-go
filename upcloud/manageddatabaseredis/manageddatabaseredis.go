...
func init() {
	...
	_jsii_.RegisterClass(
		...
		[]_jsii_.Member{
			...
			_jsii_.MemberProperty{JsiiProperty: "recoveryBasebackupName", GoGetter: "RecoveryBasebackupName"},
			_jsii_.MemberProperty{JsiiProperty: "recoveryBasebackupNameInput", GoGetter: "RecoveryBasebackupNameInput"},
			...
			_jsii_.MemberMethod{JsiiMethod: "resetRecoveryBasebackupName", GoMethod: "ResetRecoveryBasebackupName"},
