...
func (m *jsiiProxy_ManagedDatabaseRedis) validateAddMoveTargetParameters(moveTarget *string) error {
	if moveTarget == nil {
...
func (m *jsiiProxy_ManagedDatabaseRedis) validateImportFromParameters(id *string) error {
	if id == nil {
...
func (m *jsiiProxy_ManagedDatabaseRedis) validatePutNetworkParameters(value interface{}) error {
	...
	case *[]*ManagedDatabaseRedisNetwork:
		value := value.(*[]*ManagedDatabaseRedisNetwork)
	...
	case []*ManagedDatabaseRedisNetwork:
		value_ := value.([]*ManagedDatabaseRedisNetwork)
		value := &value_
		for idx_cd4240, v := range *value {
			if err := _jsii_.ValidateStruct(v, func() string { return fmt.Sprintf("parameter value[%#v]", idx_cd4240) }); err != nil {
				return err
	...
	default:
		if !_jsii_.IsAnonymousProxy(value) {
			return fmt.Errorf("parameter value must be one of the allowed types: cdktf.IResolvable, *[]*ManagedDatabaseRedisNetwork; received %#v (a %T)", value, value)
		}
	}
...
func validateManagedDatabaseRedis_GenerateConfigForImportParameters(scope constructs.Construct, importToId *string, importFromId *string) error {
	if scope == nil {
...
func (j *jsiiProxy_ManagedDatabaseRedis) validateSetCountParameters(val interface{}) error {
	switch val.(type) {
	case *float64:
		// ok
	case float64:
