...
func init() {
	_jsii_.RegisterClass(
		...
		reflect.TypeOf((*DataUpcloudManagedObjectStoragePolicies)(nil)).Elem(),
		[]_jsii_.Member{
			...
			_jsii_.MemberProperty{JsiiProperty: "serviceUuid", GoGetter: "ServiceUuid"},
			_jsii_.MemberProperty{JsiiProperty: "serviceUuidInput", GoGetter: "ServiceUuidInput"},
	...
	_jsii_.RegisterClass(
		...
		reflect.TypeOf((*DataUpcloudManagedObjectStoragePoliciesPoliciesOutputReference)(nil)).Elem(),
		[]_jsii_.Member{
