...
func (d *jsiiProxy_DataUpcloudManagedObjectStoragePoliciesPoliciesOutputReference) InterpolationForAttribute(terraformAttribute *string) cdktf.IResolvable {
...
func (d *jsiiProxy_DataUpcloudManagedObjectStoragePoliciesPoliciesOutputReference) Resolve(context cdktf.IResolveContext) interface{} {
