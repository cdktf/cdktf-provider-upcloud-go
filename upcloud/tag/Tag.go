...
import (
	...
	"github.com/cdktf/cdktf-provider-upcloud-go/upcloud/v12/tag/internal"
...
func (j *jsiiProxy_Tag) Description() *string {
	var returns *string
	_jsii_.Get(
		j,
		"description",
...
func (j *jsiiProxy_Tag) DescriptionInput() *string {
	var returns *string
	_jsii_.Get(
		j,
		"descriptionInput",
...
func (j *jsiiProxy_Tag) Servers() *[]*string {
	var returns *[]*string
	_jsii_.Get(
		j,
		"servers",
...
func (j *jsiiProxy_Tag) ServersInput() *[]*string {
	var returns *[]*string
	_jsii_.Get(
		j,
		"serversInput",
...
// Create a new {@link https://registry.terraform.io/providers/upcloudltd/upcloud/3.3.1/docs/resources/tag upcloud_tag} Resource.
...
func (j *jsiiProxy_Tag)SetDescription(val *string) {
...
func (j *jsiiProxy_Tag)SetServers(val *[]*string) {
...
func (t *jsiiProxy_Tag) ResetDescription() {
	_jsii_.InvokeVoid(
		t,
		"resetDescription",
		nil, // no parameters
...
func (t *jsiiProxy_Tag) ResetServers() {
	_jsii_.InvokeVoid(
		t,
		"resetServers",
		nil, // no parameters
