...
func (l *jsiiProxy_LoadbalancerFrontendRuleMatchersBodySizeOutputReference) InterpolationForAttribute(terraformAttribute *string) cdktf.IResolvable {
...
func (l *jsiiProxy_LoadbalancerFrontendRuleMatchersBodySizeOutputReference) Resolve(context cdktf.IResolveContext) interface{} {
