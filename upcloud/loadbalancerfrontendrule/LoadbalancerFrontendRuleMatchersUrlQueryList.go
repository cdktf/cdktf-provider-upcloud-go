...
type LoadbalancerFrontendRuleMatchersUrlQueryList interface {
	...
	// Experimental.
	ComputeFqn() *string
	Get(index *float64) LoadbalancerFrontendRuleMatchersUrlQueryOutputReference
...
// The jsii proxy struct for LoadbalancerFrontendRuleMatchersUrlQueryList
type jsiiProxy_LoadbalancerFrontendRuleMatchersUrlQueryList struct {
	internal.Type__cdktfComplexList
}

func (j *jsiiProxy_LoadbalancerFrontendRuleMatchersUrlQueryList) CreationStack() *[]*string {
	var returns *[]*string
	_jsii_.Get(
		j,
		"creationStack",
...
func (j *jsiiProxy_LoadbalancerFrontendRuleMatchersUrlQueryList) Fqn() *string {
	var returns *string
	_jsii_.Get(
		j,
		"fqn",
...
func (j *jsiiProxy_LoadbalancerFrontendRuleMatchersUrlQueryList) InternalValue() interface{} {
...
func (j *jsiiProxy_LoadbalancerFrontendRuleMatchersUrlQueryList) TerraformAttribute() *string {
	var returns *string
	_jsii_.Get(
		j,
		"terraformAttribute",
...
func (j *jsiiProxy_LoadbalancerFrontendRuleMatchersUrlQueryList) TerraformResource() cdktf.IInterpolatingParent {
...
func (j *jsiiProxy_LoadbalancerFrontendRuleMatchersUrlQueryList) WrapsSet() *bool {
	var returns *bool
	_jsii_.Get(
		j,
		"wrapsSet",
...
func (l *jsiiProxy_LoadbalancerFrontendRuleMatchersUrlQueryList) AllWithMapKey(mapKeyAttributeName *string) cdktf.DynamicListTerraformIterator {
...
func (l *jsiiProxy_LoadbalancerFrontendRuleMatchersUrlQueryList) ComputeFqn() *string {
	var returns *string
...
func (l *jsiiProxy_LoadbalancerFrontendRuleMatchersUrlQueryList) Resolve(context cdktf.IResolveContext) interface{} {
...
func (l *jsiiProxy_LoadbalancerFrontendRuleMatchersUrlQueryList) ToString() *string {
	var returns *string
