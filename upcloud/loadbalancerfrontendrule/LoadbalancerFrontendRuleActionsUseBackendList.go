...
type LoadbalancerFrontendRuleActionsUseBackendList interface {
	cdktf.ComplexList
	...
	// Experimental.
	ComputeFqn() *string
	Get(index *float64) LoadbalancerFrontendRuleActionsUseBackendOutputReference
...
// The jsii proxy struct for LoadbalancerFrontendRuleActionsUseBackendList
type jsiiProxy_LoadbalancerFrontendRuleActionsUseBackendList struct {
	internal.Type__cdktfComplexList
}

func (j *jsiiProxy_LoadbalancerFrontendRuleActionsUseBackendList) CreationStack() *[]*string {
	var returns *[]*string
	_jsii_.Get(
		j,
		"creationStack",
...
func (j *jsiiProxy_LoadbalancerFrontendRuleActionsUseBackendList) Fqn() *string {
	var returns *string
	_jsii_.Get(
		j,
		"fqn",
...
func (j *jsiiProxy_LoadbalancerFrontendRuleActionsUseBackendList) InternalValue() interface{} {
...
func (j *jsiiProxy_LoadbalancerFrontendRuleActionsUseBackendList) TerraformAttribute() *string {
	var returns *string
	_jsii_.Get(
		j,
		"terraformAttribute",
...
func (j *jsiiProxy_LoadbalancerFrontendRuleActionsUseBackendList) TerraformResource() cdktf.IInterpolatingParent {
...
func (j *jsiiProxy_LoadbalancerFrontendRuleActionsUseBackendList) WrapsSet() *bool {
	var returns *bool
	_jsii_.Get(
		j,
		"wrapsSet",
...
func (l *jsiiProxy_LoadbalancerFrontendRuleActionsUseBackendList) AllWithMapKey(mapKeyAttributeName *string) cdktf.DynamicListTerraformIterator {
...
func (l *jsiiProxy_LoadbalancerFrontendRuleActionsUseBackendList) ComputeFqn() *string {
	var returns *string
...
func (l *jsiiProxy_LoadbalancerFrontendRuleActionsUseBackendList) Resolve(context cdktf.IResolveContext) interface{} {
...
func (l *jsiiProxy_LoadbalancerFrontendRuleActionsUseBackendList) ToString() *string {
	var returns *string
