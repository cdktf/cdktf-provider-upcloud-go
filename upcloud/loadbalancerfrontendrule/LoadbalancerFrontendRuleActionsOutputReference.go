...
func (l *jsiiProxy_LoadbalancerFrontendRuleActionsOutputReference) InterpolationForAttribute(terraformAttribute *string) cdktf.IResolvable {
...
func (l *jsiiProxy_LoadbalancerFrontendRuleActionsOutputReference) Resolve(context cdktf.IResolveContext) interface{} {
