...
func (s *jsiiProxy_StorageImportOutputReference) InterpolationForAttribute(terraformAttribute *string) cdktf.IResolvable {
...
func (s *jsiiProxy_StorageImportOutputReference) Resolve(context cdktf.IResolveContext) interface{} {
