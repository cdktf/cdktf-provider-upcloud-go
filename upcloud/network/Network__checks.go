...
func (n *jsiiProxy_Network) validatePutIpNetworkParameters(value interface{}) error {
	...
	default:
		if !_jsii_.IsAnonymousProxy(value) {
			return fmt.Errorf("parameter value must be one of the allowed types: cdktf.IResolvable, *[]*NetworkIpNetwork; received %#v (a %T)", value, value)
		}
	}
...
func (j *jsiiProxy_Network) validateSetRouterParameters(val *string) error {
	if val == nil {
		return fmt.Errorf("parameter val is required, but nil was provided")
	}
...
func (j *jsiiProxy_Network) validateSetZoneParameters(val *string) error {
	if val == nil {
		return fmt.Errorf("parameter val is required, but nil was provided")
	}
