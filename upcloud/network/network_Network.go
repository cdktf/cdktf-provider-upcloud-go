...
import (
	...
	"github.com/hashicorp/cdktf-provider-upcloud-go/upcloud/v3/network/internal"
...
func (j *jsiiProxy_Network) Router() *string {
	var returns *string
	_jsii_.Get(
		j,
		"router",
...
func (j *jsiiProxy_Network) RouterInput() *string {
	var returns *string
	_jsii_.Get(
		j,
		"routerInput",
...
func (j *jsiiProxy_Network) Type() *string {
	var returns *string
	_jsii_.Get(
		j,
		"type",
...
func (j *jsiiProxy_Network) Zone() *string {
	var returns *string
	_jsii_.Get(
		j,
		"zone",
...
func (j *jsiiProxy_Network) ZoneInput() *string {
	var returns *string
	_jsii_.Get(
		j,
		"zoneInput",
...
func (j *jsiiProxy_Network)SetRouter(val *string) {
...
func (j *jsiiProxy_Network)SetZone(val *string) {
...
func (n *jsiiProxy_Network) ResetRouter() {
	_jsii_.InvokeVoid(
		n,
		"resetRouter",
		nil, // no parameters
