...
import (
	...
	"github.com/cdktf/cdktf-provider-upcloud-go/upcloud/v15/provider/internal"
...
func (j *jsiiProxy_UpcloudProvider) Token() *string {
	var returns *string
	_jsii_.Get(
		j,
		"token",
...
func (j *jsiiProxy_UpcloudProvider) TokenInput() *string {
	var returns *string
	_jsii_.Get(
		j,
		"tokenInput",
...
// Create a new {@link https://registry.terraform.io/providers/upcloudltd/upcloud/5.27.0/docs upcloud} Resource.
...
func (j *jsiiProxy_UpcloudProvider)SetToken(val *string) {
	_jsii_.Set(
		j,
		"token",
		val,
...
func (u *jsiiProxy_UpcloudProvider) ResetToken() {
	_jsii_.InvokeVoid(
		u,
		"resetToken",
		nil, // no parameters
