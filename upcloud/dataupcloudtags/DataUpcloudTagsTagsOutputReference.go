...
type DataUpcloudTagsTagsOutputReference interface {
	cdktf.ComplexObject
	...
	SetInternalValue(val *DataUpcloudTagsTags)
	Name() *string
	Servers() *[]*string
	// Experimental.
...
// The jsii proxy struct for DataUpcloudTagsTagsOutputReference
type jsiiProxy_DataUpcloudTagsTagsOutputReference struct {
	internal.Type__cdktfComplexObject
}

func (j *jsiiProxy_DataUpcloudTagsTagsOutputReference) ComplexObjectIndex() interface{} {
...
func (j *jsiiProxy_DataUpcloudTagsTagsOutputReference) ComplexObjectIsFromSet() *bool {
	var returns *bool
	_jsii_.Get(
		j,
...
func (j *jsiiProxy_DataUpcloudTagsTagsOutputReference) CreationStack() *[]*string {
	var returns *[]*string
	_jsii_.Get(
		j,
		"creationStack",
...
func (j *jsiiProxy_DataUpcloudTagsTagsOutputReference) Description() *string {
	var returns *string
	_jsii_.Get(
		j,
		"description",
...
func (j *jsiiProxy_DataUpcloudTagsTagsOutputReference) Fqn() *string {
	var returns *string
	_jsii_.Get(
		j,
		"fqn",
...
func (j *jsiiProxy_DataUpcloudTagsTagsOutputReference) InternalValue() *DataUpcloudTagsTags {
	var returns *DataUpcloudTagsTags
	_jsii_.Get(
		j,
		"internalValue",
		&returns,
...
func (j *jsiiProxy_DataUpcloudTagsTagsOutputReference) Name() *string {
	var returns *string
	_jsii_.Get(
		j,
		"name",
...
func (j *jsiiProxy_DataUpcloudTagsTagsOutputReference) Servers() *[]*string {
	var returns *[]*string
	_jsii_.Get(
		j,
		"servers",
...
func (j *jsiiProxy_DataUpcloudTagsTagsOutputReference) TerraformAttribute() *string {
	var returns *string
	_jsii_.Get(
		j,
		"terraformAttribute",
...
func (j *jsiiProxy_DataUpcloudTagsTagsOutputReference) TerraformResource() cdktf.IInterpolatingParent {
...
func NewDataUpcloudTagsTagsOutputReference_Override(d DataUpcloudTagsTagsOutputReference, terraformResource cdktf.IInterpolatingParent, terraformAttribute *string, complexObjectIndex *float64, complexObjectIsFromSet *bool) {
	_init_.Initialize()
...
func (d *jsiiProxy_DataUpcloudTagsTagsOutputReference) ComputeFqn() *string {
	var returns *string
...
func (d *jsiiProxy_DataUpcloudTagsTagsOutputReference) InterpolationAsList() cdktf.IResolvable {
	var returns cdktf.IResolvable
...
func (d *jsiiProxy_DataUpcloudTagsTagsOutputReference) InterpolationForAttribute(terraformAttribute *string) cdktf.IResolvable {
...
func (d *jsiiProxy_DataUpcloudTagsTagsOutputReference) Resolve(context cdktf.IResolveContext) interface{} {
...
func (d *jsiiProxy_DataUpcloudTagsTagsOutputReference) ToString() *string {
	var returns *string
