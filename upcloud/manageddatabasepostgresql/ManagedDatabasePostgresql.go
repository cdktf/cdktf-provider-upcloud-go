...
// Create a new {@link https://registry.terraform.io/providers/upcloudltd/upcloud/2.12.0/docs/resources/managed_database_postgresql upcloud_managed_database_postgresql} Resource.
...
func (m *jsiiProxy_ManagedDatabasePostgresql) ResetTitle() {
	_jsii_.InvokeVoid(
		m,
		"resetTitle",
		nil, // no parameters
