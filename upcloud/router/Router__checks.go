...
func (r *jsiiProxy_Router) validateMoveFromIdParameters(id *string) error {
	if id == nil {
		return fmt.Errorf("parameter id is required, but nil was provided")
	}
...
func (r *jsiiProxy_Router) validateMoveToIdParameters(id *string) error {
	if id == nil {
		return fmt.Errorf("parameter id is required, but nil was provided")
	}
...
func (r *jsiiProxy_Router) validatePutStaticRouteParameters(value interface{}) error {
	...
	case []*RouterStaticRoute:
		value_ := value.([]*RouterStaticRoute)
		value := &value_
		for idx_cd4240, v := range *value {
			if err := _jsii_.ValidateStruct(v, func() string { return fmt.Sprintf("parameter value[%#v]", idx_cd4240) }); err != nil {
				return err
	...
	default:
		if !_jsii_.IsAnonymousProxy(value) {
			return fmt.Errorf("parameter value must be one of the allowed types: cdktf.IResolvable, *[]*RouterStaticRoute; received %#v (a %T)", value, value)
		}
	}
