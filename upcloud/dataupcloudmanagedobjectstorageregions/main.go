...
func init() {
	_jsii_.RegisterClass(
		...
		reflect.TypeOf((*DataUpcloudManagedObjectStorageRegions)(nil)).Elem(),
		[]_jsii_.Member{
	...
	_jsii_.RegisterClass(
		...
		reflect.TypeOf((*DataUpcloudManagedObjectStorageRegionsRegionsOutputReference)(nil)).Elem(),
		[]_jsii_.Member{
