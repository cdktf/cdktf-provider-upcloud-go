...
func (d *jsiiProxy_DataUpcloudManagedDatabaseValkeySessionsSessionsOutputReference) InterpolationForAttribute(terraformAttribute *string) cdktf.IResolvable {
...
func (d *jsiiProxy_DataUpcloudManagedDatabaseValkeySessionsSessionsOutputReference) Resolve(context cdktf.IResolveContext) interface{} {
