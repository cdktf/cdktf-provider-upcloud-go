...
func init() {
	_jsii_.RegisterClass(
		...
		reflect.TypeOf((*DataUpcloudManagedDatabaseRedisSessions)(nil)).Elem(),
		[]_jsii_.Member{
	...
	_jsii_.RegisterClass(
		...
		reflect.TypeOf((*DataUpcloudManagedDatabaseRedisSessionsSessionsOutputReference)(nil)).Elem(),
		[]_jsii_.Member{
